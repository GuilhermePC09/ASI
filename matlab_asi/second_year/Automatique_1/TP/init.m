...
% Q0= % à compléter (expression littérale en fonction de H30)
% H10= % à compléter (expression littérale en fonction de Q0)
% H20= % à compléter (expression littérale en fonction de Q0)
